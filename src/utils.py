...
from data_utils import FashionIQDataset,ShoesDataset

if torch.cuda.is_available():
    device = torch.device("cuda")
    print('using cuda --utils')
else:
    device = torch.device("cpu")
    print('using cpu --utils')


def extract_index_features(dataset: Union[FashionIQDataset,ShoesDataset], clip_model: CLIP) -> \
